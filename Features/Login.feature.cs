...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Login with valid user name and password")]
        [NUnit.Framework.TestCaseAttribute("standard_user", "secret_sauce", "PRODUCTS", null)]
        public virtual void LoginWithValidUserNameAndPassword(string username, string password, string title, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Login with valid user name and password", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 3
...
#line hidden
#line 7
    testRunner.Then(string.Format("I should see Products page with title \"{0}\"", title), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
